...
public class ModItems {
    ...
    public static final RegistryObject<Item> REMOTE = ITEMS.register("remote", () -> new RemoteItem(new Item.Properties().component(ModDataComponents.REMOTE_PROPERTIES.get(), RemoteItem.RemoteProperties.DEFAULT).stacksTo(1)));
